...
def parse_args(debug=0):
    ...
    if debug:
        ...
        my_parser.add_argument('--split', default='NCV_lolo_target', type=str, help="|CV|: Cross Validation, w/o hyperparameter optimization; "
        ...
        # -----------------------------
        my_parser.add_argument('--task', default="tsfparsing_MF", type=str, help="Tasks: wiki_MF, bli_MF, wiki_aaMF, tsfpos, tsfel, tsfmt, tsfparsing")
        ...
        my_parser.add_argument('--burn', default=1, type=int, help="Burn in")
        ...
        # Different cases to analyse
        # **********************************
        my_parser.add_argument('--task', default="bli_aaMF", type=str, help="Tasks: wiki_MF, bli_MF, tsfpos, tsfel, tsfmt, tsfparsing")
        my_parser.add_argument('--model', default='BPMF', type=str, help="BPMF")
